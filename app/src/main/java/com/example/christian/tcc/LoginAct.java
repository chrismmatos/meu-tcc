...
public class LoginAct extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioButton radUsuario = (RadioButton)findViewById(R.id.radUsuario);
        RadioButton radAgente = (RadioButton)findViewById(R.id.radAgente);
        RadioButton radVoluntario = (RadioButton)findViewById(R.id.radVoluntario);
